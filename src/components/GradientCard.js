...
<div className="g-card">
   ...
   <div className="card-content">
       ...
       <p>Price <span className="price">{price}</span> &nbsp; &nbsp; <span className="l-text">2 of 15</span></p>
   <p>Best seller: &nbsp; <span className="price">{price}</span></p>
...
@keyframes gradient{
    ...
    50% {
        background: linear-gradient(130def, #eb3fa9, #395ff6 50%, #eb3fa9);
    }
    70% {
        background: linear-gradient(90deg, #7F41DB 0%, #022894 100%);
    }
